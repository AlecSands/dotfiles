...
# Git bare repository alias for dotfiles
alias config='/usr/bin/git --git-dir=$HOME/.cfg/ --work-tree=$HOME'

# Cursor shape changes based on vi mode
bind 'set show-mode-in-prompt on'

# Beam cursor (blinking vertical bar) for insert mode
...
# Reset to beam cursor before each command
PS0='\e[5 q'
